...
// 						row.addText(String.valueOf(row.getPos() + 1));		
						...
						row.addText("<p><span>"+LanguageUtil.get(pageContext, "don-vi")+":</span> "+(Validator.isNotNull(dossier)?dossier.getGovAgencyName():StringPool.BLANK)+"</span></p><p><span>"+LanguageUtil.get(pageContext, "amount")+":</span> <span class=\"sotien\">"+String.valueOf(NumberFormat.getInstance(new Locale("vi", "VN")).format(paymentFile.getAmount()))+StringPool.SPACE+LanguageUtil.get(pageContext, "vnd")+"</span></p><p><span>"+LanguageUtil.get(pageContext, "payment-status")+":</span><span class=\""+classColor+"\">"+paymentStatusText+"</span></p>");	
